...
public class GameController {
    ...
    private Region formenos = new Region("Formenos",
            "Early Industrial",
            "A fully underwater planet. This make their industrial standing quite impressive.",0, 0);
    ...
    private Region araboozia = new Region("Araboozia",
            "High Tech",
            "Working on their " +
                    "international space travel, the government is halting their progress though.",0, 0);
    private Region sacaguwea5 = new Region("Sacaguwea5",
            "Agricultural",
            "A planet of explorers. " +
                    "The planet is 30x bigger than the average, so there's a lot to explore.",0, 0);
